      ...
      <header className="w-full fixed top-0 left-0 z-50 glass-panel border-b border-white/10 backdrop-blur-lg">
        <div className="max-w-7xl mx-auto px-4 md:px-8 h-20 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center space-x-8">
            <a href="#cursos" className="text-sm font-sans font-semibold text-slate-600 hover:text-emerald-700 transition-colors">Nossos Cursos</a>
            <a href="#recursos" className="text-sm font-sans font-semibold text-slate-600 hover:text-emerald-700 transition-colors">Recursos Táticos</a>
            <a href="#depoimentos" className="text-sm font-sans font-semibold text-slate-600 hover:text-emerald-700 transition-colors">Aprovados</a>
          </nav>
          ...
          <div className="flex items-center space-x-4">
            <button 
              ...
              className="px-6 py-2.5 bg-emerald-700 hover:bg-emerald-800 text-white rounded-lg text-sm font-sans font-bold uppercase tracking-wide transition-all shadow-md flex items-center space-x-2 active:scale-95 cursor-pointer"
            >
      ...
      <section className="relative w-full pt-32 pb-20 md:pt-40 md:pb-32 flex items-center overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8 relative z-20 flex flex-col items-center text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center w-full space-y-4 sm:space-y-0 sm:space-x-6">
            <button 
              onClick={onNavigateToLogin}
              className="w-full sm:w-[280px] px-4 py-4 bg-emerald-700 hover:bg-emerald-800 text-white rounded-xl text-sm font-sans font-bold uppercase tracking-wider transition-all shadow-lg shadow-emerald-900/50 flex items-center justify-center space-x-2 hover:scale-105 active:scale-95 cursor-pointer"
            >
